  ...
  const itineraryList = [
    {
      itinerary_id: 1,
      budget: 300,
      title: "Austria Itinerary1",
      destinations: [
        { id: 1, name: "Marina Bay Sands", cost: 50, notes: "Iconic hotel" },
        { id: 2, name: "Sentosa Island", cost: 50, notes: "Futuristic hotel" },
      ],
    },
    {
      itinerary_id: 2,
      budget: 300,
      title: "Austria Itinerary2",
      destinations: [
        { id: 1, name: "Marina Bay Sands", cost: 50, notes: "Iconic hotel" },
        { id: 2, name: "Sentosa Island", cost: 50, notes: "Futuristic hotel" },
      ],
  ...
  const deleteItinerary = async (itineraryID) => {
    try {
      ...
      const response = await axios.post(
        "https://localhost:3001/itinerary/" + itineraryID,
      );
          ...
          <Grid item xs={12} md={6} lg={4} key={item.itinerary_id}>
            <Item sx={{ padding: 0 }}>
              <Card>
                ...
                <IconButton
                  onClick={() => {
                    handleDeleteClick(item.itinerary_id);
                  }}
                >
